...
public sealed class InvPriceListConfiguration : IEntityTypeConfiguration<InvPriceList>
{
    public void Configure(EntityTypeBuilder<InvPriceList> builder)
    {
        builder.ToTable("INV_PRICE_LIST");
...
public sealed class InvPriceListItemConfiguration : IEntityTypeConfiguration<InvPriceListItem>
{
    public void Configure(EntityTypeBuilder<InvPriceListItem> builder)
    {
        builder.ToTable("INV_PRICE_LIST_ITEM");
