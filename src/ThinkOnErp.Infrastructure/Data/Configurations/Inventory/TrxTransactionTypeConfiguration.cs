...
public sealed class TrxTransactionTypeConfiguration : IEntityTypeConfiguration<TrxTransactionType>
{
    public void Configure(EntityTypeBuilder<TrxTransactionType> builder)
    {
        ...
        builder.Property(t => t.TrxCode).HasColumnName("TRX_CODE").ValueGeneratedNever();
        builder.Property(t => t.DocTypeCode).HasColumnName("DOC_TYPE_CODE").IsRequired();
        builder.Property(t => t.TrxKey).HasColumnName("TRX_KEY").HasMaxLength(50).IsRequired();
        builder.Property(t => t.TrxNameAr).HasColumnName("TRX_NAME_AR").HasMaxLength(100).IsRequired();
        ...
        builder.Property(t => t.StockDirection).HasColumnName("STOCK_DIRECTION").HasColumnType("NUMBER(2)").HasDefaultValue(0);
