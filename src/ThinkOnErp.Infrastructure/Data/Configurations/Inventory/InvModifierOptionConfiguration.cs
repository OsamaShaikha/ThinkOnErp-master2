...
public sealed class InvModifierOptionConfiguration : IEntityTypeConfiguration<InvModifierOption>
{
    public void Configure(EntityTypeBuilder<InvModifierOption> builder)
    {
        builder.ToTable("INV_MODIFIER_OPTION");
