...
public sealed class InvItemConfiguration : IEntityTypeConfiguration<InvItem>
{
    public void Configure(EntityTypeBuilder<InvItem> builder)
    {
        ...
        builder.Property(i => i.ReorderPoint).HasColumnName("REORDER_POINT").HasColumnType("NUMBER(14,4)");
        builder.Property(i => i.SafetyStock).HasColumnName("SAFETY_STOCK").HasColumnType("NUMBER(14,4)");
        builder.Property(i => i.MinOrderQty).HasColumnName("MIN_ORDER_QTY").HasColumnType("NUMBER(14,4)");
        builder.Property(i => i.LeadTimeDays).HasColumnName("LEAD_TIME_DAYS");

        builder.Property(i => i.Weight).HasColumnName("WEIGHT").HasColumnType("NUMBER(14,4)");
