...
public sealed class PosModifierGroupConfiguration : IEntityTypeConfiguration<PosModifierGroup>
{
    public void Configure(EntityTypeBuilder<PosModifierGroup> builder)
    {
        builder.ToTable("POS_MODIFIER_GROUP");
