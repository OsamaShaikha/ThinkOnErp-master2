...
public sealed class ApAgingAnalysisViewConfiguration : IEntityTypeConfiguration<ApAgingAnalysisView>
{
    public void Configure(EntityTypeBuilder<ApAgingAnalysisView> builder)
    {
        builder.ToView("VW_AP_AGING_ANALYSIS");
        builder.HasNoKey();

        builder.Property(e => e.TransactionId).HasColumnName("TRANSACTION_ID");
        builder.Property(e => e.VendorCode).HasColumnName("VENDOR_CODE").HasMaxLength(50);
        builder.Property(e => e.VendorNameLocal).HasColumnName("VENDOR_NAME_LOCAL").HasMaxLength(200);
        builder.Property(e => e.VendorNameEn).HasColumnName("VENDOR_NAME_EN").HasMaxLength(200);
