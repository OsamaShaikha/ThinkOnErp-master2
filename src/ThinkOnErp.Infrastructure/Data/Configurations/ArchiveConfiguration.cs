...
public class SysAuditLogArchiveConfiguration : IEntityTypeConfiguration<SysAuditLogArchive>
{
    public void Configure(EntityTypeBuilder<SysAuditLogArchive> builder)
    {
        ...
        builder.Property(e => e.ArchivedDate).HasColumnName("ARCHIVED_DATE").IsRequired();
        builder.Property(e => e.ArchiveBatchId).HasColumnName("ARCHIVE_BATCH_ID").IsRequired();
    }
}

public class SysRetentionPolicyConfiguration : IEntityTypeConfiguration<SysRetentionPolicy>
{
    public void Configure(EntityTypeBuilder<SysRetentionPolicy> builder)
    {
        ...
        builder.Property(e => e.LastModifiedDate).HasColumnName("LAST_MODIFIED_DATE");
