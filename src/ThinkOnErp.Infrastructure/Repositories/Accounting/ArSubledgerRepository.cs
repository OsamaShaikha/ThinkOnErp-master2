...
public sealed class ArSubledgerRepository : IArSubledgerRepository
{
    ...
    public async Task<IReadOnlyList<ThinkOnErp.Domain.Entities.Views.ArAgingAnalysisView>> GetAgingAnalysisFromViewAsync(long? branchId, DateTime asOfDate, CancellationToken cancellationToken = default)
    {
        var query = _context.ArAgingAnalysisViews
            .AsNoTracking()
