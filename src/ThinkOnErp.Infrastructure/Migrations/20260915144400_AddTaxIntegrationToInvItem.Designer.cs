...
namespace ThinkOnErp.Infrastructure.Migrations
{
    ...
    [Migration("20260915144400_AddTaxIntegrationToInvItem")]
    partial class AddTaxIntegrationToInvItem
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ThinkOnErp.Domain.Entities.Accounting.PaymentMethod", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("NUMBER(19)")
                    ...
                    b.Property<bool>("AutoPostGl")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("NUMBER(1)")
                        .HasDefaultValue(true)
                        .HasColumnName("AUTO_POST_GL");
                    ...
                    b.Property<decimal>("CommissionFixedAmount")
                        .ValueGeneratedOnAdd()
                        .HasPrecision(18, 4)
                        .HasColumnType("DECIMAL(18,4)")
                        .HasDefaultValue(0m)
                        .HasColumnName("COMMISSION_FIXED_AMOUNT");

                    b.Property<string>("CommissionGlAccountCode")
                        .HasMaxLength(50)
                        .HasColumnType("NVARCHAR2(50)")
                        .HasColumnName("COMMISSION_GL_ACCOUNT_CODE");
                    ...
                    b.Property<bool>("RequiresDueDate")
                        ...
                        .HasColumnType("NUMBER(1)")
                        .HasDefaultValue(false)
                        .HasColumnName("REQUIRES_DUE_DATE");
                    ...
                    b.Property<bool>("ShowInInvoices")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("NUMBER(1)")
                        .HasDefaultValue(true)
                        .HasColumnName("SHOW_IN_INVOICES");
                    ...
                    b.Property<bool>("ShowInVouchers")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("NUMBER(1)")
                        .HasDefaultValue(true)
                        .HasColumnName("SHOW_IN_VOUCHERS");
                    ...
                    b.HasIndex("CommissionGlAccountCode");

                    b.HasIndex("GlAccountCode");

                    b.HasIndex("BranchId", "Code")
                        .IsUnique()
                        .HasDatabaseName("UX_PM_BRANCH_CODE");
            ...
            modelBuilder.Entity("ThinkOnErp.Domain.Entities.Pos.PosItemModifierGroup", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("NUMBER(19)")
                    ...
                    b.ToTable("POS_ITEM_MODIFIER_GROUP", (string)null);
                });

            modelBuilder.Entity("ThinkOnErp.Domain.Entities.Pos.PosModifierGroup", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("NUMBER(19)")
                    ...
                    b.ToTable("POS_MODIFIER_GROUP", (string)null);
                });

            modelBuilder.Entity("ThinkOnErp.Domain.Entities.Pos.PosModifierOption", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("NUMBER(19)")
                    ...
                    b.Property<string>("OptionNameEn")
                        .HasMaxLength(150)
                        .HasColumnType("NVARCHAR2(150)")
                        .HasColumnName("OPTION_NAME_EN");

                    b.Property<string>("OptionNameLocal")
                        .IsRequired()
                        .HasMaxLength(150)
                        .HasColumnType("NVARCHAR2(150)")
                        .HasColumnName("OPTION_NAME_LOCAL");
                    ...
                    b.ToTable("POS_MODIFIER_OPTION", (string)null);
                });
            ...
            modelBuilder.Entity("ThinkOnErp.Domain.Entities.Accounting.PaymentMethod", b =>
                {
                    ...
                    b.HasOne("ThinkOnErp.Domain.Entities.Accounting.CashRegister", "CashRegister")
                        .WithMany()
                        .HasForeignKey("CashRegisterId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("ThinkOnErp.Domain.Entities.Accounting.GlAccount", "CommissionGlAccount")
                        .WithMany()
                        .HasForeignKey("CommissionGlAccountCode")
                        .OnDelete(DeleteBehavior.Restrict);
                    ...
                    b.Navigation("CommissionGlAccount");
            ...
            modelBuilder.Entity("ThinkOnErp.Domain.Entities.Pos.PosItemModifierGroup", b =>
                {
                    ...
                    b.HasOne("ThinkOnErp.Domain.Entities.Pos.PosModifierGroup", "ModifierGroup")
                        .WithMany("ItemLinks")
            ...
            modelBuilder.Entity("ThinkOnErp.Domain.Entities.Pos.PosModifierOption", b =>
                {
                    ...
                    b.HasOne("ThinkOnErp.Domain.Entities.Inventory.InvItem", "RelatedItem")
                        .WithMany()
