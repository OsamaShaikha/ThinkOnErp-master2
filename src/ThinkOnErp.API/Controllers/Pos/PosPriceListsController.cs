...
/// <summary>
/// Point of Sale Price Lists API: Manages channel-specific menus, dine-in vs delivery price lists, and item pricing overrides.
/// </summary>
[ApiController]
...
[TenantScoped]
[Authorize]
public class PosPriceListsController : ControllerBase
{
    private readonly IPosPriceListService _priceListService;

    public PosPriceListsController(IPosPriceListService priceListService)
    {
