...
public class PosPriceList
{
    ...
    public ICollection<PosPriceListItem> Items { get; set; } = new List<PosPriceListItem>();
}

public class PosPriceListItem
{
    public long Id { get; set; }
    ...
    // Navigation
    public PosPriceList? PriceList { get; set; }
