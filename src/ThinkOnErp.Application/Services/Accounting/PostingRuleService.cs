...
public sealed class PostingRuleService : IPostingRuleService
{
    ...
    public async Task SeedDefaultPostingRulesAsync(long? branchId, string username, CancellationToken cancellationToken = default)
    {
        ...
        {
            // Sales
            new() { BranchId = branchId, Module = "SALES", EventType = "SALES_INVOICE", EventNameAr = "فاتورة مبيعات آجل", EventNameEn = "Credit Sales Invoice", DebitAccountCode = "112101", CreditAccountCode = "410101", DefaultVoucherType = 1, DescriptionTemplate = "إيراد فاتورة مبيعات رقم {InvoiceNo}" },
            new() { BranchId = branchId, Module = "SALES", EventType = "CASH_SALES", EventNameAr = "فاتورة مبيعات نقدي", EventNameEn = "Cash Sales Invoice", DebitAccountCode = "111101", CreditAccountCode = "410101", DefaultVoucherType = 2, DescriptionTemplate = "مبيعات نقدية فاتورة رقم {InvoiceNo}" },
            new() { BranchId = branchId, Module = "SALES", EventType = "SALES_DISCOUNT", EventNameAr = "خصم مسموح به (مبيعات)", EventNameEn = "Sales Discount Allowed", DebitAccountCode = "410201", CreditAccountCode = "112101", DefaultVoucherType = 1, DescriptionTemplate = "خصم مسموح به للعميل {PartyCode}" },
            
            // Purchases
            new() { BranchId = branchId, Module = "PURCHASES", EventType = "PURCHASE_BILL", EventNameAr = "فاتورة مشتريات آجل", EventNameEn = "Credit Purchase Bill", DebitAccountCode = "113101", CreditAccountCode = "211101", DefaultVoucherType = 1, DescriptionTemplate = "فاتورة شراء بضاعة من المورد {PartyCode}" },
            new() { BranchId = branchId, Module = "PURCHASES", EventType = "PURCHASE_DISCOUNT", EventNameAr = "خصم مكتسب (مشتريات)", EventNameEn = "Purchase Discount Received", DebitAccountCode = "211101", CreditAccountCode = "420101", DefaultVoucherType = 1, DescriptionTemplate = "خصم مكتسب من المورد {PartyCode}" },
            
            // Receipts & Payments
            new() { BranchId = branchId, Module = "CASH_BANK", EventType = "CUSTOMER_RECEIPT_CASH", EventNameAr = "سند قبض نقدي من عميل", EventNameEn = "Customer Cash Receipt", DebitAccountCode = "111101", CreditAccountCode = "112101", DefaultVoucherType = 2, DescriptionTemplate = "قبض نقدي من العميل {PartyCode}" },
            new() { BranchId = branchId, Module = "CASH_BANK", EventType = "CUSTOMER_RECEIPT_BANK", EventNameAr = "سند قبض حوالة بنكية", EventNameEn = "Customer Bank Receipt", DebitAccountCode = "111201", CreditAccountCode = "112101", DefaultVoucherType = 2, DescriptionTemplate = "حوالة بنكية من العميل {PartyCode}" },
            new() { BranchId = branchId, Module = "CASH_BANK", EventType = "VENDOR_PAYMENT_CASH", EventNameAr = "سند صرف نقدي لمورد", EventNameEn = "Vendor Cash Payment", DebitAccountCode = "211101", CreditAccountCode = "111101", DefaultVoucherType = 3, DescriptionTemplate = "دفعة نقدية للمورد {PartyCode}" },
            new() { BranchId = branchId, Module = "CASH_BANK", EventType = "VENDOR_PAYMENT_BANK", EventNameAr = "سند صرف تحويل بنكي لمورد", EventNameEn = "Vendor Bank Payment", DebitAccountCode = "211101", CreditAccountCode = "111201", DefaultVoucherType = 3, DescriptionTemplate = "تحويل بنكي للمورد {PartyCode}" },

            // PDC
            new() { BranchId = branchId, Module = "PDC", EventType = "PDC_INWARD_RECEIPT", EventNameAr = "استلام شيك آجل من عميل", EventNameEn = "PDC Inward Receipt", DebitAccountCode = "111301", CreditAccountCode = "112101", DefaultVoucherType = 2, DescriptionTemplate = "شيك آجل برسم التحصيل رقم {ChequeNo}" },
            new() { BranchId = branchId, Module = "PDC", EventType = "PDC_INWARD_CLEAR", EventNameAr = "تحصيل شيك مقبوض بالبنك", EventNameEn = "PDC Inward Clearing", DebitAccountCode = "111201", CreditAccountCode = "111301", DefaultVoucherType = 1, DescriptionTemplate = "تحصيل شيك رقم {ChequeNo} وإيداعه بالبنك" },
            new() { BranchId = branchId, Module = "PDC", EventType = "PDC_INWARD_BOUNCE", EventNameAr = "ارتداد شيك مقبوض", EventNameEn = "PDC Inward Bounce", DebitAccountCode = "112101", CreditAccountCode = "111301", DefaultVoucherType = 1, DescriptionTemplate = "إلغاء وإعادة فتح مديونية لارتداد الشيك رقم {ChequeNo}" },
            new() { BranchId = branchId, Module = "PDC", EventType = "PDC_OUTWARD_ISSUE", EventNameAr = "إصدار شيك آجل لمورد", EventNameEn = "PDC Outward Issuance", DebitAccountCode = "211101", CreditAccountCode = "211201", DefaultVoucherType = 3, DescriptionTemplate = "شيك صادر للمورد {PartyCode} رقم {ChequeNo}" },
            new() { BranchId = branchId, Module = "PDC", EventType = "PDC_OUTWARD_CLEAR", EventNameAr = "صرف شيك صادر من البنك", EventNameEn = "PDC Outward Clearing", DebitAccountCode = "211201", CreditAccountCode = "111201", DefaultVoucherType = 1, DescriptionTemplate = "خصم من البنك لصرف الشيك الصادر رقم {ChequeNo}" },

            // Inventory & COGS
            new() { BranchId = branchId, Module = "INVENTORY", EventType = "COGS_POSTING", EventNameAr = "إثبات تكلفة البضاعة المباعة", EventNameEn = "Cost of Goods Sold Posting", DebitAccountCode = "510101", CreditAccountCode = "113101", DefaultVoucherType = 1, DescriptionTemplate = "تكلفة مبيعات البضاعة المباعة" },
            new() { BranchId = branchId, Module = "INVENTORY", EventType = "INVENTORY_DAMAGE", EventNameAr = "إثبات تالف وهالك المخزون", EventNameEn = "Inventory Damage Write-off", DebitAccountCode = "520901", CreditAccountCode = "113101", DefaultVoucherType = 1, DescriptionTemplate = "تسوية هالك مخزون" },

            // Fixed Assets & FX
            new() { BranchId = branchId, Module = "FIXED_ASSETS", EventType = "MONTHLY_DEPRECIATION", EventNameAr = "قيد الإهلاك الشهري للأصول", EventNameEn = "Monthly Asset Depreciation", DebitAccountCode = "520801", CreditAccountCode = "120901", DefaultVoucherType = 1, DescriptionTemplate = "إهلاك الأصول الثابتة للفترة" },
            new() { BranchId = branchId, Module = "FX", EventType = "FX_UNREALIZED_GAIN", EventNameAr = "أرباح تقييم فروق العملة", EventNameEn = "Unrealized FX Gain", DebitAccountCode = "111201", CreditAccountCode = "420201", DefaultVoucherType = 1, DescriptionTemplate = "أرباح فروق تقييم أسعار العملات الأجنبية" },
            new() { BranchId = branchId, Module = "FX", EventType = "FX_UNREALIZED_LOSS", EventNameAr = "خسائر تقييم فروق العملة", EventNameEn = "Unrealized FX Loss", DebitAccountCode = "580101", CreditAccountCode = "111201", DefaultVoucherType = 1, DescriptionTemplate = "خسائر فروق تقييم أسعار العملات الأجنبية" },
            new() { BranchId = branchId, Module = "CASH_BANK", EventType = "BANK_CHARGES", EventNameAr = "المصاريف والعمولات البنكية", EventNameEn = "Bank Fees & Charges", DebitAccountCode = "510901", CreditAccountCode = "111201", DefaultVoucherType = 1, DescriptionTemplate = "عمولات ومصاريف بنكية" }
        };
