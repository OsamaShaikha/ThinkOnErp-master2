...
public class DataTypeMappingUnitTests : IClassFixture<TestWebApplicationFactory>
{
    ...
    public async Task OracleVarchar2_MappedToCSharpString()
    {
        ...
        var command = new CreateRoleCommand
        {
            RoleNameLocal = "Arabic Description",
        ...
        // Assert
        Assert.NotNull(role);
        Assert.IsType<string>(role.RoleNameLocal);
        Assert.IsType<string>(role.RoleNameEn);
        Assert.Equal("Arabic Description", role.RoleNameLocal);
    ...
    public async Task OracleIsActiveN_MappedToCSharpFalse()
    {
        ...
        var command = new CreateRoleCommand
        {
            RoleNameLocal = "Role To Deactivate",
