-- =====================================================
-- Fix Runtime Errors - Combined Script (Version 3)
...
EXCEPTION
    WHEN OTHERS THEN
        IF SQLCODE = -2443 THEN
            DBMS_OUTPUT.PUT_LINE('! Constraint CHK_AUDIT_LOG_ACTOR_TYPE does not exist (this is OK)');
        ELSE
...
-- Add the new check constraint with SYSTEM and ANONYMOUS included
...
COMMENT ON COLUMN SYS_AUDIT_LOG.ACTOR_TYPE IS 'Type of actor: SUPER_ADMIN, COMPANY_ADMIN, USER, SYSTEM, or ANONYMOUS';
...
PROMPT 1. ✓ Updated SYS_AUDIT_LOG.ACTOR_TYPE constraint to allow 'SYSTEM' and 'ANONYMOUS'
...
PROMPT - Audit logging for authentication events (including failed logins) should succeed
PROMPT =====================================================
